...
public class ConceptCoreBlock extends UnitCodecEntityBlock implements IConceptSocketed {
    public ConceptCoreBlock(net.minecraft.world.level.block.state.BlockBehaviour.Properties settings) {
        super(settings);
                        ...
                        try {
                            ...
                            for (ConceptModifierBlockEntity entity : modifierBlocks){
                                ...
                                if (modifier.type == ConceptModifier.ModifierType.ATTRIBUTE){
                                    Holder<Attribute> attribute = modifier.getAttributeType();
    ...
    public VoxelShape getShape(BlockState state, BlockGetter view, BlockPos pos, CollisionContext context){
        return switch (state.getValue(BlockStateProperties.AXIS)){
            case X -> Shapes.box(0.0 / 16, 2.0 / 16, 2.0 / 16, 16.0 / 16, 14.0 / 16, 14.0 / 16);
            case Y -> Shapes.box(2.0 / 16, 0.0 / 16, 2.0 / 16, 14.0 / 16, 16.0 / 16, 14.0 / 16);
            case Z -> Shapes.box(2.0 / 16, 2.0 / 16, 0.0 / 16, 14.0 / 16, 14.0 / 16, 16.0 / 16);
        };
    }
