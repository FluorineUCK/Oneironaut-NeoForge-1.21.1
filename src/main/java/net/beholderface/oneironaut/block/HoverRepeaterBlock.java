...
public class HoverRepeaterBlock extends Block {
    public HoverRepeaterBlock(net.minecraft.world.level.block.state.BlockBehaviour.Properties settings) {
        super(settings);
    }
    ...
    public void animateTick(BlockState state, Level world, BlockPos pos, RandomSource random) {
        ...
        for (int i = 0; i < limit; i++){
            world.addParticle(new ConjureParticleOptions(HoverElevatorBlockEntity.defaultColor()),
