...
public class RenderBerryBushBlock extends BushBlock implements BonemealableBlock {
    ...
    public RenderBerryBushBlock(net.minecraft.world.level.block.state.BlockBehaviour.Properties settings) {
        super(settings);
    ...
    private boolean harvest(BlockState state, Level world, BlockPos pos, Player player,
                            InteractionHand hand, ItemStack clickStack) {
        int age = state.getValue(AGE);
        ...
        if (age > 1) {
            ...
            if (fullGrown && clickStack.getItem() == Items.SHEARS){
                ...
                clickStack.hurtAndBreak(1, player,
    ...
    protected ItemInteractionResult useItemOn(ItemStack stack, BlockState state, Level world, BlockPos pos,
        ...
        if (harvest(state, world, pos, player, hand, stack)) {
    ...
    protected InteractionResult useWithoutItem(BlockState state, Level world, BlockPos pos,
        ...
        if (harvest(state, world, pos, player, InteractionHand.MAIN_HAND, player.getMainHandItem())) {
