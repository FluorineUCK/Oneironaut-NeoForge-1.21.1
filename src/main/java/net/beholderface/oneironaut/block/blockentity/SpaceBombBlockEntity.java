...
public class SpaceBombBlockEntity extends BlockEntity {
    ...
    private void showParticles(boolean preparing, boolean imminent){
        ...
        Vec3 doublePos = Vec3.atCenterOf(worldPosition);
    ...
    protected void loadAdditional(CompoundTag nbt, HolderLookup.Provider registries) {
        ...
        this.countdown = nbt.contains(COUNTDOWN_TAG) ? nbt.getInt(COUNTDOWN_TAG) : COUNTDOWN_LENGTH;
        int[] posArray = nbt.getIntArray(POSITION_TAG);
        this.cachedPos = posArray.length >= 3
