...
public class ReverberationRod extends ItemPackagedHex  {
    ...
    public static final ResourceLocation CASTING_PREDICATE = Oneironaut.id("is_casting");
    private static final Map<UUID, ReverbRodCastEnv> ROD_ENV_MAP = new HashMap<>();
    public ReverberationRod(net.minecraft.world.item.Item.Properties settings){
        super(settings);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand usedHand) {
        ...
        stack.onUseTick(world, player, stack.getUseDuration(player));
    ...
    private boolean castHex(ItemStack stack, ServerLevel world, ServerPlayer sPlayer, InteractionHand usedHand){
        ...
        if (delay <= 0){
            ...
            if (sound != null) {
                ...
                if (world.getGameTime() >= ctx.lastSoundTimestamp + 30 || ctx.getSound() == HexEvalSounds.MISHAP.get()){
