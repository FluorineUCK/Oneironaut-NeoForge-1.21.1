...
public class GeneralNoisyStaff extends ItemStaff {
    ...
    public GeneralNoisyStaff(net.minecraft.world.item.Item.Properties pProperties, SoundEvent openSound, SoundEvent resetSound, @Nullable Float[] soundModifiers) {
        super(pProperties);
