...
public class RenderThorns extends Item {
    public RenderThorns(net.minecraft.world.item.Item.Properties settings) {
        super(settings);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player user, InteractionHand hand) {
        ...
        if (user instanceof ServerPlayer serverPlayer){
            ...
            AdvancementHolder ouchie = world.getServer().getAdvancements().get(ResourceLocation.tryBuild("oneironaut","prick_self"));
            if (ouchie != null && !tracker.getOrStartProgress(ouchie).isDone()) {
