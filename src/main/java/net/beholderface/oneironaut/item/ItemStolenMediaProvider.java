...
public class ItemStolenMediaProvider extends Item {
    ...
    public ItemStolenMediaProvider(Item.Properties settings, long mediaAmt, boolean grabFromInventory, int priority){
        super(settings);
    ...
    public ItemStolenMediaProvider(Item.Properties settings, int mediaAmt){
        this(settings, mediaAmt, true, ADMediaHolder.CHARGED_AMETHYST_PRIORITY);
    }

    public ItemStolenMediaProvider(Item.Properties settings, long mediaAmt, int priority){
