...
public class ConceptModifierManager extends SavedData {
    ...
    public static ConceptModifierManager createFromNbt(CompoundTag nbt, HolderLookup.Provider registries){
    ...
    public static ConceptModifierManager getServerState(MinecraftServer server){
        ...
        ConceptModifierManager manager = stateManager.computeIfAbsent(
                new SavedData.Factory<>(ConceptModifierManager::new, ConceptModifierManager::createFromNbt), ID);
        manager.setDirty();
        return manager;
    }
