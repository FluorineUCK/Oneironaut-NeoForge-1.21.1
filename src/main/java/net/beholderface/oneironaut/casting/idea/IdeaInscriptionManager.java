...
public class IdeaInscriptionManager extends SavedData {
    ...
    public CompoundTag save(CompoundTag nbt, HolderLookup.Provider registries) {
        ...
        while (iotaIterator.hasNext()){
            ...
            CompoundTag serialized = nextEntry.getValue().serialize(registries);
            if (serialized != null) {
                nbt.put(nextEntry.getKey(), serialized);
            }
        }
        return nbt;
    }
    ...
    public static IdeaInscriptionManager createFromNbt(CompoundTag nbt, HolderLookup.Provider registries){
    ...
    public static IdeaInscriptionManager getServerState(MinecraftServer server){
        ...
        IdeaInscriptionManager ideas = stateManager.computeIfAbsent(
                new SavedData.Factory<>(IdeaInscriptionManager::new, IdeaInscriptionManager::createFromNbt), ID);
        ideas.setDirty();
        return ideas;
    }
